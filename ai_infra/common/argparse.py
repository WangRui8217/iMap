...
def add_common_args(parser: argparse.ArgumentParser):
    ...
    eda_group.add_argument("--design_file", type=str, default='/home/eda230218/gitcode/iMAP/ai_infra/results/data/aig', help="Design filepath")
    eda_group.add_argument("--designs_group_id", type=str, required=True, help="ID of group of designs to consider")
    ...
    # eda_group.add_argument("--libary", type=str, default=os.path.join(ROOT_PROJECT, 'asap7.lib'),
    #                        help="library file for mapping")
    eda_group.add_argument("--libary", type=str, default='/home/eda230218/gitcode/iMAP/ai_infra/lib/imap.cpython-37m-x86_64-linux-gnu.so',
                           help="library file for mapping")
    eda_group.add_argument("--imap_binary", type=str, default='/home/eda230218/gitcode/iMAP/bin/imap')
